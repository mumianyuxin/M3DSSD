...
def Config():
    ...
    # align 
    conf.center_align = True
    conf.shape_align = True
    ...
    # detection sampling
    conf.batch_size = 4
    conf.display_iter /= conf.batch_size
    ...
    # It is better to train with pretrained model when training model with feature alignment
    # conf.pretrained = 'path to pretrained model'
