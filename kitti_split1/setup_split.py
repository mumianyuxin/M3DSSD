...
for line in text_file:
    ...
    if parsed is not None:
        ...
        if not os.path.exists(os.path.join(kitti_tra['ims'], str(new_id) + extra)):
            os.symlink(os.path.join(kitti_raw['ims'], str(id) + extra), os.path.join(kitti_tra['ims'], str(new_id) + extra))
...
for line in text_file:
    ...
    if parsed is not None:
        ...
        if not os.path.exists(os.path.join(kitti_val['ims'], str(new_id) + extra)):
            os.symlink(os.path.join(kitti_raw['ims'], str(id) + extra), os.path.join(kitti_val['ims'], str(new_id) + extra))
